      ...
      <main className="container mx-auto px-4 py-12 flex flex-col md:flex-row items-center justify-center relative z-10 w-full max-w-5xl gap-10">
        ...
        <div className="w-full md:w-1/2 relative flex justify-center items-end order-2 md:order-2 z-20">
          <img
            ...
            alt="Fauzan Profile"            className="w-72 z-20 mt-[-10rem] md:w-96 h-auto object-cover drop-shadow-xl [-webkit-mask-image:linear-gradient(to_bottom,black_60%,transparent_100%)] [mask-image:linear-gradient(to_bottom,black_60%,transparent_100%)]"
          />
