  ...
  return (
    ...
    >
      ...
      <div className="relative space-y-20">
        ...
        <div className="absolute left-5 md:left-1/2 top-0 h-full w-px bg-zinc-100" />

        {/* Timeline line (animated) */}
        <motion.div
          style={{ height: lineHeight }}
          className="absolute left-5 md:left-1/2 top-0 w-px origin-top bg-zinc-800"
        />
          ...
          return (
            ...
            >
              ...
              <motion.div
                ...
                className="ml-10 md:ml-0 md:w-[calc(50%-3rem)] rounded-xl border border-zinc-200 bg-gray-900 p-5 shadow-sm "
              >
